...
def sample_dataframe(df: pd.DataFrame, sample_size: int = 1000, random_state: int = 42) -> pd.DataFrame:
    ...
    try:
        ...
        if len(categorical_cols) > 0:
            ...
            for col in categorical_cols:
                stats['categorical_stats'][col] = df[col].value_counts().head(10).to_dict()
